	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'umedia' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'umedia' ); ?></th>
			</tr>
		</thead>
		<tbody>
